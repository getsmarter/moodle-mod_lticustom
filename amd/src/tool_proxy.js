 ...
 *
 * @module     mod_lticustom/tool_proxy
 * @class      tool_proxy
...
define(['core/ajax', 'core/notification'], function(ajax, notification) {
    return /** @alias module:mod_lticustom/tool_proxy */ {
        /**
        ...
        query: function(args) {
            var request = {
                methodname: 'mod_lticustom_get_tool_proxies',
                args: args || {}
            };
        ...
        'delete': function(id) {
            var request = {
                methodname: 'mod_lticustom_delete_tool_proxy',
                args: {
                    id: id
                }
            };
         ...
         *
         * See mod/lticustom/classes/external.php create_tool_proxy_parameters
         *
         * @method create
         * @public
        ...
        create: function(args) {
            var request = {
                methodname: 'mod_lticustom_create_tool_proxy',
                args: args
            };
