 ...
 *
 * See template: mod_lticustom/tool_card
 *
 * @module     mod_lticustom/tool_card_controller
 ...
 */
 define(['jquery', 'core/ajax', 'core/notification', 'core/templates', 'core/modal_factory',
        'mod_lticustom/tool_type', 'mod_lticustom/events', 'mod_lticustom/keys',
        'core/str'],
    ...
    var setStatusActive = function(element) {
        ...
        promise.then(function(toolTypeData) {
            ...
            return templates.render('mod_lticustom/tool_card', toolTypeData);
    ...
    var registerModal = function(element) {
        ...
        var bodyPromise = templates.render('mod_lticustom/tool_config_modal_body', context);
        ...
        var footerPromise = templates.render('mod_lticustom/tool_config_modal_footer', context);
        modalFactory.create({
          large: true,
    ...
    return /** @alias module:mod_lticustom/tool_card_controller */ {
