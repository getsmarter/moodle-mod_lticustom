 ...
 *
 * @module     mod_lticustom/tool_configure_controller
 ...
 * @since      3.1
 */
define(['jquery', 'core/ajax', 'core/notification', 'core/templates', 'mod_lticustom/events', 'mod_lticustom/keys', 'mod_lticustom/tool_type',
        'mod_lticustom/tool_proxy', 'core/str'],
    ...
    var reloadToolList = function() {
        ...
        $.when(
            ...
            .done(function(types, proxies) {
                    templates.render('mod_lticustom/tool_list', {tools: types, proxies: proxies})
    ...
    var addTool = function() {
        ...
        promise.fail(function() {
            str.get_string('errorbadurl', 'mod_lticustom')
                .done(function(s) {
