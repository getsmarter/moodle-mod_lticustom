 ...
 *
 * See template: mod_lticustom/external_registration
 *
 * @module     mod_lticustom/external_registration
 ...
 * @since      3.1
 */
define(['jquery', 'core/ajax', 'core/notification', 'core/templates', 'mod_lticustom/events',
        'mod_lticustom/tool_proxy', 'mod_lticustom/tool_type', 'mod_lticustom/keys', 'core/str'],
     ...
     *
     * See mod_lticustom/tool_proxy_registration_form template.
     *
    ...
    var getRegistrationRequest = function(id) {
        var request = {
            methodname: 'mod_lticustom_get_tool_proxy_registration_request',
            args: {
                id: id
            }
        };
    ...
    var cancelRegistration = function() {
        ...
        promise.done(function() {
            ...
            finishExternalRegistration();
            stopLoadingCancel();
            str.get_string('failedtodeletetoolproxy', 'mod_lticustom').done(function(s) {
                var feedback = {
                    message: s,
                    error: true
                };
    ...
    var renderExternalRegistrationWindow = function(registrationRequest) {
        var promise = templates.render('mod_lticustom/tool_proxy_registration_form', registrationRequest);
    ...
    var promptForToolTypeCapabilitiesAgreement = function(typeData) {
        ...
        templates.render('mod_lticustom/tool_type_capabilities_agree', typeData).done(function(html, js) {
    ...
    var registerEventListeners = function() {
        ...
        // parameters.
        //
        // See AMD module mod_lticustom/external_registration_return.
        window.triggerExternalRegistrationComplete = function(data) {
            ...
            if (data.status == "success") {
                str.get_string('successfullycreatedtooltype', 'mod_lticustom').done(function(s) {
                    feedback.message = s;
                }).fail(notification.exception);
    ...
    return /** @alias module:mod_lticustom/external_registration */ {
