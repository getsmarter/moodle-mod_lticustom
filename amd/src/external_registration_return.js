 ...
 *
 * See also: mod/lticustom/externalregistrationreturn.php
 *
 * @module     mod_lticustom/external_registration_return
...
define([], function() {
    ...
    return /** @alias module:mod_lticustom/external_registration_return */ {
