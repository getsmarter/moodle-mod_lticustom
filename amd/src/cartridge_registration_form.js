 ...
 *
 * See template: mod_lticustom/cartridge_registration_form
 *
 * @module     mod_lticustom/cartridge_registration_form
 ...
 * @since      3.1
 */
define(['jquery', 'core/ajax', 'core/notification', 'mod_lticustom/tool_type', 'mod_lticustom/events', 'mod_lticustom/keys', 'core/str'],
    ...
    var submitCartridgeURL = function() {
        ...
        promise.done(function() {
            ...
            str.get_string('failedtocreatetooltype', 'mod_lticustom').done(function(s) {
                $(document).trigger(ltiEvents.NEW_TOOL_TYPE);
                $(document).trigger(ltiEvents.STOP_CARTRIDGE_REGISTRATION);
                $(document).trigger(ltiEvents.REGISTRATION_FEEDBACK, {
                    message: s,
    ...
    return /** @alias module:mod_lticustom/cartridge_registration_form */ {
