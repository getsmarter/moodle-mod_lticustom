 ...
 *
 * See template: mod_lticustom/contentitem
 *
 * @module     mod_lticustom/contentitem
 * @class      contentitem
    ...
    function($, notification, str, templates, FormField, ModalFactory, ModalEvents) {
        ...
        var contentItem = {
            ...
            init: function(url, postData, cb) {
                ...
                var bodyPromise = templates.render('mod_lticustom/contentitem', context);
                ...
                str.get_string('selectcontent', 'lticustom').then(function(title) {
        ...
        /**
         * Window function that can be called from mod_lticustom/contentitem_return to close the dialogue and process the return data.
         *
