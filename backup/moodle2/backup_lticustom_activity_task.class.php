...
/**
 * Defines backup_lticustom_activity_task class
 *
...
require_once($CFG->dirroot . '/mod/lticustom/backup/moodle2/backup_lticustom_stepslib.php');

/**
 * Provides the steps to perform one complete backup of the LTI instance
 */
class backup_lticustom_activity_task extends backup_activity_task {
    ...
    protected function define_my_steps() {
        $this->add_step(new backup_lticustom_activity_structure_step('lticustom_structure', 'lticustom.xml'));
    }
