 ...
 */
class restore_lticustom_activity_structure_step extends restore_activity_structure_step {
    ...
    protected function define_structure() {
        ...
        $this->add_subplugin_structure('lticustomsource', $lti);
        $this->add_subplugin_structure('lticustomservice', $lti);
    ...
    protected function process_lti($data) {
        ...
        $newitemid = $DB->insert_record('lticustom', $data);
    ...
    protected function process_ltitype($data) {
        ...
        $DB->update_record('lticustom', ['id' => $this->get_new_parentid('lticustom'), 'typeid' => $ltitypeid]);
    }
    ...
    protected function process_ltitypesconfig($data) {
        ...
        if ($data->typeid && $this->newltitype) {
            ...
            $DB->insert_record('lticustom_types_config', $data);
        }
    }
    ...
    protected function process_ltitoolsetting($data) {
        ...
        $DB->insert_record('lticustom_tool_settings', $data);
    }
    ...
    protected function process_ltisubmission($data) {
        ...
        $data->ltiid = $this->get_new_parentid('lticustom');
    ...
    protected function after_execute() {
        ...
        $this->add_related_files('mod_lticustom', 'intro', null);
    }
}
