 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_lticustom_service_exception_handler_testcase extends advanced_testcase {
    /**
    ...
    public function test_handle_log() {
        ...
        $this->assertTrue(is_dir($CFG->dataroot.'/temp/mod_lticustom'));
        $files = glob($CFG->dataroot.'/temp/mod_lticustom/mod*');
