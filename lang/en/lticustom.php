...
$string['modulename'] = 'External tool custom';
...
$string['modulename_link'] = 'mod/lticustom/view';
$string['modulename_shortcut_link'] = 'mod/lticustom/view/custom';
...
$string['pluginname'] = 'External tool custom';
...
$string['privacy:metadata:lticustom_tool_proxies'] = 'LTI proxies';
$string['privacy:metadata:lticustom_tool_proxies:name'] = 'LTI proxy name';
