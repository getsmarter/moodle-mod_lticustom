...
class TrivialOAuthDataStore extends OAuthDataStore {
     ...
     * @param string $consumerkey     Consumer key
     *
     * @return moodle\mod\lticustom\OAuthConsumer  OAuthConsumer object
     */
     ...
     *
     * @param moodle\mod\lticustom\OAuthConsumer $consumer     Consumer
     * @param string $tokentype    Type of token
     * @param string $token        Token ID
     *
     * @return moodle\mod\lticustom\OAuthToken OAuthToken object
     */
