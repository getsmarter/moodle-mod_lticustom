...
$isget = $response->get_request_method() === mod_lticustom\local\ltiservice\resource_base::HTTP_GET;
$isdelete = $response->get_request_method() === mod_lticustom\local\ltiservice\resource_base::HTTP_DELETE;
