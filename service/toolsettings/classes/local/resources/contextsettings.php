 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class contextsettings extends \mod_lticustom\local\ltiservice\resource_base {
    ...
    public function execute($response) {
        ...
        if (!$ok) {
            ...
            if (!$ok) {
                ...
                $systemsetting = null;
                $contextsettings = lticustom_get_tool_settings($id, $contextid);
                if (!empty($bubble)) {
                ...
                if ($response->get_request_method() == 'GET') {
                    ...
                    if ($ok) {
                        lticustom_set_tool_settings($settings, $id, $contextid);
                    } else {
