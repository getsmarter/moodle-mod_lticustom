...
/**
 * Strings for component 'lticustomservice_basicoutcomes', language 'en'
 *
...
$string['lticustomservice_basicoutcomes'] = 'Basic Outcomes';
$string['lticustomservice_basicoutcomes_help'] = 'Allow the tool to save and retrieve its grades to a gradebook column associated with each link.';
$string['notallow'] = 'Do not use this service';
$string['pluginname'] = 'Basic Outcomes Service Custom';
