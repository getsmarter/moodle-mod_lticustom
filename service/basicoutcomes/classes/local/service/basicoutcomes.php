...
namespace lticustomservice_basicoutcomes\local\service;
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class basicoutcomes extends \mod_lticustom\local\ltiservice\service_base {
    ...
    public function get_resources() {
        ...
        if (empty($this->resources)) {
            ...
            $this->resources[] = new \lticustomservice_basicoutcomes\local\resources\basicoutcomes($this);
        }
    ...
    public function get_permitted_scopes() {
        ...
        $scopes = array();
        if (!isset($this->get_typeconfig()['acceptgrades']) || ($this->get_typeconfig()['acceptgrades'] != LTI_CUSTOM_SETTING_NEVER)) {
