...
$capabilities = array(
    ...
    'mod/lticustom:addinstance' => array(
    ...
    // otherwise they are given Learner. See the lticustom_get_ims_role function.
    'mod/lticustom:manage' => array(
    ...
    'mod/lticustom:addcoursetool' => array(
        'captype' => 'write',
        'contextlevel' => CONTEXT_COURSE,
        'archetypes' => array(
            'editingteacher' => CAP_ALLOW,
    ...
    'mod/lticustom:requesttooladd' => array(
        'captype' => 'write',
        'contextlevel' => CONTEXT_COURSE,
        'archetypes' => array(
            'editingteacher' => CAP_ALLOW,
