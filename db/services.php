...
$functions = array(
    ...
    'mod_lticustom_get_tool_launch_data' => array(
        'classname'     => 'mod_lticustom_external',
        'methodname'    => 'get_tool_launch_data',
        'description'   => 'Return the launch data for a given external tool.',
        'type'          => 'read',
        'capabilities'  => 'mod/lticustom:view',
        'services'      => array(MOODLE_OFFICIAL_MOBILE_SERVICE)
    ),

    'mod_lticustom_get_ltis_by_courses' => array(
        'classname'     => 'mod_lticustom_external',
    ...
    'mod_lticustom_get_tool_proxies' => array(
        'classname'     => 'mod_lticustom_external',
    ...
    'mod_lticustom_create_tool_proxy' => array(
        'classname'     => 'mod_lticustom_external',
    ...
    'mod_lticustom_delete_tool_proxy' => array(
        'classname'     => 'mod_lticustom_external',
    ...
    'mod_lticustom_get_tool_proxy_registration_request' => array(
        'classname'     => 'mod_lticustom_external',
    ...
    'mod_lticustom_get_tool_types' => array(
        'classname'     => 'mod_lticustom_external',
    ...
    'mod_lticustom_create_tool_type' => array(
        'classname'     => 'mod_lticustom_external',
    ...
    'mod_lticustom_update_tool_type' => array(
        'classname'     => 'mod_lticustom_external',
    ...
    'mod_lticustom_delete_tool_type' => array(
        'classname'     => 'mod_lticustom_external',
    ...
    'mod_lticustom_is_cartridge' => array(
        'classname'     => 'mod_lticustom_external',
